...
class PDFCV(FPDF):
    ...
    def generate_cv(self,name,email,phone,address,skills,work_experience,education,about_me):
        ...
        self.set_font("Ariel","B",10)
        self.cell(0,10,"email: {}",format(email),new_x="LMARGIN",new_y="NEXT")
        self.cell(0,10,"phone: {}",format(phone),new_x="LMARGIN",new_y="NEXT")
        ...
        self.ln(10)
        self.set_font("Ariel","B",12)
        self.cell(0,10,"work_experience",new_x="LMARGIN",new_y="NEXT",align="L")
        ...
        for education_item in education:
            self.cell(0,5,"{}:{}".format(education_item[title]),education_item["university"],new_x="LMARGIN",new_y="NEXT")
        
        
        self.ln(10)   
        self.set_font("Ariel","B",12)
        self.cell(0,10,"about_me",new_x="LMARGIN",new_y="NEXT",align="L")
...
def generate_cv_pdf():
    ...
    qrcode.png("mywebsitre.png",scale=6)
    
    
    if not name or not email or not phone or not address or not skills or not education:
        messagebox.showerror("error","please enter the details of which required")
        return
...
label_education=Label(window,text="education(one skill per line informat'degree':'university)")
